 ...
 * they function as the base command, e.g. {@code /foo} would be a base command, with each
...
public abstract class PluginCommand extends HandledCommand implements CommandExecutor, TabCompleter {
     ...
     */
    protected PluginCommand(@NotNull final String name, @NotNull final String permission, final boolean playersOnly) {
     ...
     * @return If the command was processed by the linked.
     */
    @Override

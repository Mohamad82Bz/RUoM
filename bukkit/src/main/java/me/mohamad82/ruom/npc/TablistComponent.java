...
public class TablistComponent extends PlayerNPC {
    ...
    private TablistComponent(Component component, String string, Optional<MinecraftSkin> skin) {
     ...
     */
    public static TablistComponent tablistComponent(Component component, String string, Optional<MinecraftSkin> skin) {

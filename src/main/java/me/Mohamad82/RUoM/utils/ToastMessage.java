...
public class ToastMessage {
    ...
    PACKET_PLAY_OUT_ADVANCEMENTS, CRAFT_ADVANCEMENT_PROGRESS;
    ...
    private static Method ADVANCEMENT_SERIALIZE_METHOD, ADVANCEMENT_DESERIALIZE_METHOD, ADVANCEMENT_PROGRESS_UPDATE_METHOD,
    ...
    protected ToastMessage(String title, XMaterial icon, FrameType frameType, boolean trimCharacters) {
        ...
        try {
            ...
            Object nmsSerializedAdvancement = ADVANCEMENT_SERIALIZE_METHOD.invoke(null, jsonAdvancement, LOOT_DESERIALIZATION_CONTEXT_CONSTRUCTOR.newInstance(advancementKey, LOOT_PREDICATE_MANAGER_CONSTRUCTOR.newInstance()));
